...
try:
	...
	print >> sys.stderr, ( 'You do not have Tkinter, which is needed for the graphical interface, you will only be able to use the command line.' )
	print >> sys.stderr, ( 'Information on how to download Tkinter is at:\nwww.tcl.tk/software/tcltk/' )
...
class Filename( BooleanPreference ):
	...
	def execute( self ):
		try:
			...
			print >> sys.stderr, ( 'Oops, ' + self.name + ' could not get filename.' )
...
class FloatPreference( BooleanPreference ):
	...
	def setValueToString( self, valueString ):
		...
		try:
			...
			print >> sys.stderr, ( 'Oops, can not read float' + self.name + ' ' + valueString )
...
class IntPreference( FloatPreference ):
	...
	def setValueToString( self, valueString ):
		...
		try:
			...
			print >> sys.stderr, ( 'Oops, can not read integer ' + self.name + ' ' + valueString )
