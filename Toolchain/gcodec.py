...
def replaceWords( filenames, wordReplacements ):
	...
	for filename in filenames:
		...
		print >> sys.stderr, ( 'In the file ' + filename )
		print >> sys.stderr, ( 'The following replacements are being made:' )
		...
		for wordReplacement in wordReplacements:
			print >> sys.stderr, ( wordReplacement[ 0 ] + ' with ' + wordReplacement[ 1 ] )
...
def writeFileMessageEnd( end, filename, fileText, message ):
	...
	print >> sys.stderr, ( message + getSummarizedFilename( suffixFilename ) )
...
def writeFileText( filename, fileText ):
	...
	try:
		...
		print >> sys.stderr, ( 'The file ' + filename + ' can not be written to.' )
