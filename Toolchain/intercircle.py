...
def addCircleIntersectionLoop( circleIntersectionPath, circleIntersections ):
	...
	for circleIntersectionIndex in range( len( circleIntersections ) + 1 ):
		...
		if circleIntersectionAhead.steppedOn == True:
			print >> sys.stderr, ( 'circleIntersectionAhead.steppedOn == True' )
			print >> sys.stderr, ( circleIntersectionAhead )
		circleIntersectionAhead.addToList( circleIntersectionPath )
	firstCircleIntersection.steppedOn = True
	print >> sys.stderr, ( "addCircleIntersectionLoop would have gone into an endless loop, this should never happen." )
	print >> sys.stderr, ( "circleIntersectionPath" )
	for circleIntersection in circleIntersectionPath:
		print >> sys.stderr, ( circleIntersection )
		print >> sys.stderr, ( circleIntersection.circleNodeAhead )
		print >> sys.stderr, ( circleIntersection.circleNodeBehind )
	print >> sys.stderr, ( "firstCircleIntersection" )
	print >> sys.stderr, ( firstCircleIntersection )
	print >> sys.stderr, ( "circleIntersections" )
...
def addPointsFromSegment( points, radius, pointBegin, pointEnd ):
	...
	if segmentLength == 0.0:
		print >> sys.stderr, ( 'This should never happen, segmentLength = 0.0' )
		print >> sys.stderr, ( 'pointBegin' )
		print >> sys.stderr, ( pointBegin )
		print >> sys.stderr, ( pointEnd )
		return
