...
print >> sys.stderr, ( 'Extrude has been imported.' )
print >> sys.stderr, ( 'The gcode files in this directory that are not log files are the following:' )
print >> sys.stderr, ( getGCodeFilesWhichAreNotLogFiles() )