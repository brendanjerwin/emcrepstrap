...
print >> sys.stderr, ( 'Analyze has been imported.' )
print >> sys.stderr, ( 'The gcode files in this directory that are not comment files are the following:' )
print >> sys.stderr, ( getUncommentedGcodeFiles() )